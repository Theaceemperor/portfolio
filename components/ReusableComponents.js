...
import { AdsNotification } from './alert';
...
export function PricingCard({ title, discount, children }) {
    ...
    return (
        <div className="bg-black dark:bg-wheat text-wheat dark:text-black p-4 rounded shadow shadow-black dark:shadow-amber-600">
            ...
            <Link href={"/auth/signup"} className='text-amber-600 font-medium flex items-center justify-center mt-4 hover:bg-wheat dark:hover:bg-black px-2 py-1 rounded gap-2'>Get Started <BsArrowRight /></Link>
        </div>
    )
}
...
export function SubscribeBox() {
    ...
    return (
        <div id='subscription' className='mb-4 container mx-auto'>
            <p className='mb-2 p-1 text-sm md:text-base text-center'>Subscribe to our mailing list to stay updated on exciting news and our product updates.</p>
            <form className='flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0 items-center justify-center'>
                <input
                id='subscribeEmail'
                name='subscribeEmail'
                placeholder='Email address'
                className='max-w-lg rounded bg-transparent px-2 py-1 dark:text-amber-600 text-black focus:outline-none outline-none border border-amber-600 placeholder:italic dark:placeholder:text-white/70'  
                onChange={
        ...
        <footer ref={ref} id="footer" className={`mx-1 mt-8 rounded shadow transition-opacity ease-linear duration-700 ${isVisible1 ? "opacity-100" : "opacity-0"}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 sm:text-center gap-5 p-5 text-xs">
                <ul className="flex flex-col space-y-2">
                    ...
                    <li><Link href={'/projects#solutions'} className="hover:underline underline-offset-2 decoration-amber-600">Products</Link></li>
                    ...
                    <li><Link href={'/contact'} className="hover:underline underline-offset-2 decoration-amber-600">Contact Us</Link></li>
                    </ul>
                    <ul className="flex flex-col gap-1">
                    <li><Link href={'/auth'} className="hover:underline underline-offset-2 decoration-amber-600">Track your development</Link></li>
                    <li><Link href={'/auth/signup'} className="hover:underline underline-offset-2 decoration-amber-600">Build a website</Link></li>
                    <li><Link href={'/pricing'} className="hover:underline underline-offset-2 decoration-amber-600">Pricing</Link></li>
                    <li><Link href={'/contact'} className="hover:underline underline-offset-2 decoration-amber-600">Get a template</Link></li>
                    <li><Link href={'/docs'} className="hover:underline underline-offset-2 decoration-amber-600">Docs</Link></li>
                    <li>
                ...
                <ul className="flex flex-col gap-1">
                    <li><Link href={'/dev-support'} className="hover:underline underline-offset-2 decoration-amber-600">Dev support</Link></li>
                    <li><Link href={'/terms'} className="hover:underline underline-offset-2 decoration-amber-600">T & C</Link></li>
                    <li><Link href={'/privacy-policy'} className="hover:underline underline-offset-2 decoration-amber-600">Privacy</Link></li>
...
export function SubNav({ modeSwitch }) {
    ...
    return (
        <>
            <div className='hidden lg:block border-none bg-black text-wheat dark:bg-wheat dark:text-black z-30 fixed top-0 bottom-0 left-0 w-64 py-4'>
                ...
                <div className='flex flex-col space-y-2 px-4 overflow-y-scroll no-scrollbar'>
                    ...
                    {session
                    ?
                    <Link href="/dashboard" className={pathName === '/dashboard' ? 'text-amber-600 font-bold' : `hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300`}>Dashboard</Link>
                    :
                    <Link href="/auth" className={pathName === '/auth' ? 'text-amber-600 font-bold' : `hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300`}>Login</Link>
                    }
                    {session
                    ?
                    ...
                    :
                    <Link href="/auth/signup" className={pathName === '/auth/signup' ? 'text-amber-600 font-bold' : `hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300`}>Sign Up</Link>
                    }
                    <Link href="/gift-purchase" className={pathName === '/gift-purchase' ? 'text-amber-600 font-bold' : `hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300`}>Gift Cards</Link>
                    <Link href="/pricing" className={pathName === '/pricing' ? 'text-amber-600 font-bold' : `hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300`}>Pricing</Link>
                    ...
                    <Link href="/reviews" className={pathName === '/reviews' ? 'text-amber-600 font-bold' : `hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300`}>Reviews & FAQ</Link>
                    ...
                    <Link href={'/contact'} className={pathName === '/contact' ? 'text-amber-600 font-bold' : `hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300`}>Contact Us</Link>
                    <Link href="/privacy-policy" className={pathName === '/privacy-policy' ? 'text-amber-600 font-bold' : `hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300`}>Privacy & Terms</Link>
                    <Link href="/dev-support" className={pathName === '/dev-support' ? 'text-amber-600 font-bold' : `hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300`}>Dev Support</Link>
                </div>
                <p className='p-2 text-sm absolute bottom-0'>&copy; 2024 Spades. All rights reserved.</p>
            </div>
                    ...
                    <div className="container mx-auto flex lg:hidden justify-between items-center">
                        ...
                        {isMenuOpen && (
                            <div className="absolute top-12 left-0 right-0 flex flex-col space-y-2 max-h-screen overflow-y-scroll p-4 bg-black/80 rounded transition duration-300 ease-linear">
                                ...
                                {session
                                ?
                                <Link href="/dashboard" onClick={() => setIsMenuOpen(false)} className={pathName === '/dashboard' ? "text-wheat font-semibold block" : "block hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300"}>Dashboard</Link>
                                :
                                <Link href="/auth" onClick={() => setIsMenuOpen(false)} className={pathName === '/auth' ? "text-wheat font-semibold block" : "block hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300"}>Login</Link>
                                }
                                {session
                                ?
                                ...
                                :
                                <Link href="/auth/signup" onClick={() => setIsMenuOpen(false)} className={pathName === '/auth/signup' ? "text-wheat font-semibold block" : "block hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300"}>Sign Up</Link>
                                }
                                <Link href="/gift-purchase" onClick={() => setIsMenuOpen(false)} className={pathName === '/gift-purchase' ? "text-wheat font-semibold block" : "block hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300"}>Gift Cards</Link>
                                <Link href="/pricing" onClick={() => setIsMenuOpen(false)} className={pathName === '/pricing' ? "text-wheat font-semibold block" : "block hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300"}>Pricing</Link>
                                ...
                                <Link href="/reviews" onClick={() => setIsMenuOpen(false)} className={pathName === '/reviews' ? "text-wheat font-semibold block" : "block hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300"}>Reviews & FAQ</Link>
                                ...
                                <Link href="/contact" onClick={() => setIsMenuOpen(false)} className={pathName === '/contact' ? "text-wheat font-semibold block" : "block hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300"}>Contact Us</Link>
                                <Link href="/privacy-policy" onClick={() => setIsMenuOpen(false)} className={pathName === '/privacy-policy' ? "text-wheat font-semibold block" : "block hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300"}>Privacy & Terms</Link>
                                <Link href="/dev-support" onClick={() => setIsMenuOpen(false)} className={pathName === '/dev-support' ? "text-wheat font-semibold block" : "block hover:underline decoration-amber-600 underline-offset-4 ease-in-out duration-300"}>Dev Support</Link>
                            </div>
                        )}
                    </div>
                </nav>
