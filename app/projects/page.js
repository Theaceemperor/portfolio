...
export default function Page() {
    const [ projectImages,setProjectImages ] = React.useState([
        { id: 'raconsult', projectDesc1: "This will be a block of text to describe the product, check in later for the product's description; or visit the product page!", productDesc2: "This will be a block of text to describe the product, check in later for the product's description; or visit the product page!", image1: '/portfolio/raconsult/raconsult2.PNG', image2: '/portfolio/raconsult/raconsult.PNG', projectLink: 'https://royalacumenconsult.com', projectName: 'Royal Acumen Consult', overview: 'This project was built with React using Nextjs as a framework for development. It is fast and optimized for S.E.O' },
