    ...
    return (
        <>
            <main className="px-2 mt-8">
                <div className="flex flex-col mb-8 text-center items-center justify-center gap-5 lg:grid lg:grid-cols-2">
                    ...
                    <div>
                        <div className="flex flex-col justify-center items-center text-center px-1 mt-4">
                            ...
                            <p className="font-semibold mb-4">Write a message or give us some feedback/review</p>
                        </div>
                ...
                <div className="flex flex-col items-center mb-8 justify-center lg:flex-row md:flex-row gap-4">
                    <LoginButton2 />
                    <VisitHomePage />
                </div>
