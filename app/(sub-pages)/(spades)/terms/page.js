    ...
    return (
        <>
            <div className="mt-4 ml-4">
                <Link href={"/privacy-policy"} className="flex items-center w-fit bg-amber-600 text-black rounded px-6 py-2 hover:shadow-md hover:bg-wheat hover:shadow-amber-600 transition duration-300 ease-in-out font-bold text-lg">Privacy Policy <CgArrowRight className="text-xl ml-2" /></Link>
            </div>
            <h1 className="about-h2 text-center my-8 font-bold underline">TERMS OF USE</h1>
