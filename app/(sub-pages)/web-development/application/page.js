    ...
    return (
        ...
        <main>
            ...
            <div className="mt-8 px-2">
                ...
                <form className="p-2 sm:p-4 flex flex-col mt-4 items-center justify-center space-y-4 bg-wheat rounded-lg shadow-lg shadow-black/70 "
                ...
                <p className="mt-4 text-center px-2">Have an account? Login <Link href={'/web-development'}><i className="underline text-amber-600">here</i></Link></p>
            </div>
        </main>
    )
}
